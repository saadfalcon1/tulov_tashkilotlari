...
export function TopBanksChart({ data, platform = "googlePlay" }: TopBanksChartProps) {
  ...
  const platformTitle = platform === "appStore"
    ? "App Store: Yakuniy ball bo'yicha top 15 to‘lov tashkilotlarining mobil ilovasi"
    : "Google Play: Yakuniy ball bo'yicha top 15 to‘lov tashkilotlarining mobil ilovasi";
